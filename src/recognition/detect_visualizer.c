...
void visu_draw_border_box(image *input, int *border_box, unsigned char r,
                          unsigned char g, unsigned char b)
{
    // Draw the border box rectangle
    image_draw_rectangle(input, *(border_box), /* x1 */
                         *(border_box + 1), /* y1 */
                         *(border_box + 2), /* x2 */
                         *(border_box + 3), /* y2*/
                         r, g, b);
...
void visu_draw_border_letter(image *input, l_list *char_list, unsigned char r,
                             unsigned char g, unsigned char b)
{
    for (size_t i = 0; i < list_length(char_list); i += 4)
    {
        image_draw_rectangle(input, list_get_value(char_list, i),
                             list_get_value(char_list, i + 1),
                             list_get_value(char_list, i + 2),
                             list_get_value(char_list, i + 3), r, g, b);
    }
}
