...
void image_draw_line_h(image *input, unsigned int x1, unsigned int x2,
                       unsigned int y, unsigned char r, unsigned char g,
                       unsigned char b)
{
    // Draw a line from x1 -> x2
    for (unsigned int current_x = x1; current_x < x2; current_x++)
    {
...
void image_draw_line_v(image *input, unsigned int x, unsigned int y1,
                       unsigned int y2, unsigned char r, unsigned char g,
                       unsigned char b)
{
    // Draw a line from y1 -> y2
    for (unsigned int current_y = y1; current_y < y2; current_y++)
    {
...
void image_draw_rectangle(image *input, unsigned int x1, unsigned int y1,
                          unsigned int x2, unsigned int y2, unsigned char r,
